...
public class TrafficBehaviorServiceTest {
	...
	void testFootpassengerCrossTheStreet_shouldNotThrowBehaviorExceptionWhenFootpassengerCrossesTheRoadSafely() {
		...
		assertDoesNotThrow(() -> trafficBehaviorService.footpassengerCrossTheStreet(currentTraffic, currentFootpassengerBehavior));
	}
